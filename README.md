...
### STR Models
You can download the pretrained models used in our paper directly and put them at ```STR_modules/downloads_models/```. Their checkpoints can be downloaded [here](https://drive.google.com/drive/folders/1ciaBucPd1u0qDTjJe3DuxLvMIMf9R1zu?usp=drive_link).
...
## Citation
If you find this work useful for your research, please cite [our paper](https://dl.acm.org/doi/abs/10.1145/3581783.3612076):
```
